...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex items-cente justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>        
        ...
        <div className='flex items-center gap-4'>
            {
                ...
                ? <div className='flex items-center gap-2 cursor-pointer group relative' >
                    ...
                    <img className='w-5' src={dropdown_icon} alt=''/>
                ...
                :<button onClick={()=> navigate ('/login')} className='bg-amber-600 text-white px-8 py-3 rounded-full font-light hidden md:block'> Create account </button>
