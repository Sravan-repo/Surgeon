...
import AkakiImage from '../assets/Akaki.jpg';
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-6 md:px-12 mt-8">
      ...
      <div className="w-full flex flex-col md:flex-row mb-12 gap-8 items-center">
        ...
        Akaki Tsereteli State University, a higher-education institution in Kutaisi, Georgia, was established in July 1930. The university emphasizes continuous staff training, quality education, and a global curriculum that focuses on creating a labor force that can respond to the job market. 
        Headed by an academic council, followed by a rector, and then the teacher, as well as other staff, Akaki Tsereteli State University has a structured management. 
        The Medical Doctor program at Akaki Tsereteli State University offered in the English language of instruction, was implemented in 2012. 
        Provisions such as Project-Based Learning and Virtual handling of patients are made available in the MD program at Akaki Tsereteli State University. Following the sector benchmarks of the World Federation of Medical Education, the university has global accreditations that make its degree recognized around the world.</p>
        </header>
      </div>
      ...
      <section className="mb-5 text-sm ">
        <h2 className="font-semibold text-md text-black mb-2">
          Address of Akaki Tsereteli State University
        </h2>
