...
const address = 'Tsinandali Street, 9, Isani-Samgori District, Tbilisi, Georgia';
    ...
    <div className="max-w-6xl mx-auto py-10 px-6 md:px-12 mt-8">
      ...
      <div className="w-full flex flex-col md:flex-row mb-12 gap-8 items-center">
        ...
        <header className="w-full md:w-1/2 text-center md:text-left">
          <h1 className="text-3xl md:text-3xl font-semibold text-blue-900 mb-3 leading-tight">
            Georgian National University | SEU | Fees, Admission & Ranking 
          </h1>
          <p className="text-sm text-gray-800">
         Georgian National University SEU is the largest higher education institution in Georgia in the private sector. The university has advanced technology in the form of clinical laboratories, a simulation clinic, a Data science lab equipped with AI, and many other resources. Georgian National University SEU believes in providing global exposure to medical students through exchange programs, collaborations, and double degrees. With multiple university partnerships and affiliations in and outside Europe, Georgian National University SEU facilitates unmatched facilities, such as an esteemed faculty, to create vibrant and successful medical experts of the future. Headed by the Partner’s Assembly, followed by the Rector, and an Academic Council, the management at Georgian National University SEU ensures that students get easy access to information, as well as facilities provided by the government.          </p>
        </header>
      </div>
      ...
      <section className="mb-5 text-sm ">
        <h2 className="font-semibold text-md text-black mb-2">
          Address of Georgian National University | SEU
        </h2>
        ...
        <h3 className="font-medium text-md text-black mt-3 mb-2">At Georgian National University SEU, the Medical Course in English follows important goals that are as follows:</h3>
            <li>The importance of the study of clinical science, biomedicine, and life-long learning.</li>
            <li>Clinical reasoning based on case studies.</li>
            <li>Development of practical, interpersonal, and clinical skills.</li>
            <li>The ethical, professional, and legal responsibilities of a physician.</li>
        </ul>
        </section>
        ...
        <ul className="list-disc ml-5 text-sm space-y-1">
            <li><strong className='text-black font-semibold'>Medicine</strong>: The MD course in Medicine at Georgian National University SEU is of 6 years, and has 12 semesters in total. After successful completion of the program, the student is awarded a master’s degree in medicine and can practice as a physician.</li>
        </ul>
        </section>

        {/* Facilities */}
        <section ref={sectionRefs.facilities} id="facilities" className="mb-5 scroll-mt-24">
        <h2 className="font-semibold text-md text-black mb-3">Facilities at Georgian National University SEU</h2>
        <ul className="list-disc ml-5 text-sm space-y-1">
            <li><strong className='font-semibold'>Library:</strong>The library at Georgian National University SEU is digitized, and has resource books that are highly relevant to the medical students. With electronic resources such as electronic scientific databases, and resources on digital carriers that can be used by students with their registered student ID, and password, the university management has made it easier for the medical students to complete their studies with ease. Some of the available resources for medical students at the library are:</li>
            ...
            <li><strong className='font-semibold'>Hostel Facility:</strong>Georgian National University SEU has plans to build a student hostel, and dormitory shortly. For a comfortable stay outside the university campus, you can get in touch with Reddys Overseas since we have a list of apartments and hostels that can match your requirements and budget.</li>
        </ul>
        </section>
     ...
     <section ref={sectionRefs.eligibility} id="eligibility" className="mb-5 scroll-mt-24">
      ...
      <section
        ...
        {/* <p className="text-sm mb-2 text-gray-900">
            The main simplified admission steps are:
        </p> */}
        {/* <ol className="list-decimal ml-5 text-sm mb-2 text-gray-900 space-y-2">
            <li>Submit application online with required details.</li>
            <li>Provide scanned educational documents and proof of identity.</li>
            <li>Receive the offer letter from the university.</li>
            <li>Apply for student visa and arrange travel to Georgia.</li>
        </ol> */}
        </section>
      ...
      {/* Fees Structure */}
        ...
        <div className="overflow-x-auto mb-5">
            ...
            <thead className="bg-gray-100">
                <tr>
                <th className="text-center border border-gray-300 bg-gray-500 p-2">Georgian National University</th>
