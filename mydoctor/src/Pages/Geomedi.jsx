...
import GeomediImage from '../assets/Geomedi.jpg';
...
const address = '3 Krtsanisi St, Tbilisi, Georgia';
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-6 md:px-12 mt-8">
      ...
      <div className="w-full flex flex-col md:flex-row mb-12 gap-8 items-center">
       ...
       Geomedi University in Tbilisi is an institution of higher education specializing in medical and healthcare studies. 
       With the Faculty of Medicine established in 1998, the university aims to inculcate universal values in the field of education, 
       develop higher and continuing education, and promote research activities. The management of Geomedi University provides facilities
        such as high-tech laboratories, an auditorium, and modern clinical bases for training. With four faculties in the field of medicine and healthcare, Geomedi University ensures that students have access to the latest facilities at the university clinics, simulation clinic, laboratories, and research centers to become competent future physicians. The university clinic,
         Geomedi Rehabilitation Clinic and Simulation Medicine Clinic serve as a huge resource for medical students to complete their medical internship at the patient’s bedside.
          </p>
        </header>
      </div>
      ...
      <section className="mb-5 text-sm ">
        ...
        <ul className="list-disc ml-5 text-sm space-y-1">
          <h3 className="font-medium text-md text-black mt-3 mb-2">The Faculty of Medicine at Geomedi University offers the Medical Doctor program in English. Some goals and objectives of the Faculty of Medicine are as follows:</h3>
            <li>Implementing international standards to impart theoretical and practical knowledge of medicine and healthcare among medical students.</li>
            <li>Provide a friendly environment in terms of academic staff and facilities so that medical students can develop and maximize their potential and become professionals with ethics and values to serve the community</li>
            </ul>
        </section>
        ...
        <h2 className="font-semibold text-md text-black mb-3">Facilities at the Geomedi University</h2>
        <ul className="list-disc ml-5 text-sm space-y-1">
            <li><strong className='font-semibold'>Library:</strong>With spaces to read and study in the form of study halls, reading rooms, consultation rooms, computer rooms, copy room, and even a library staff open space, the university provides all printed and e-resources at the library for students and staff members to discover and integrate information in a new way. Students of the university can readily access these resources from anywhere using their student ID and password. Some of the popular e-resources provided by the library at Geomedi University are as follows:</li>
            <ul className="list-disc ml-5 space-y-1">
                <li>EBSCO – 11 databases</li>
                <li>Elsevier databases</li>
                <li>ScienceDirect 2000 scientific journals</li>
                <li>Scopus@ - largest database of international citations and abstracts</li>
            </ul>
            <li><strong className='font-semibold'>Clubs & Associations: </strong>Georgian National University SEU allows students to participate, in and create different clubs, and unions, or even organize events, based on their area of interest. Some such clubs, and associations formed at the university are:</li>
                <ul className="list-disc ml-5 space-y-1">
                    ...
                    <li><strong className='font-semibold'>Student Clubs:</strong>To satisfy the intellectual, and overall developmental needs of the students, Georgian National University SEU, at present, has the following clubs for students to participate in:
                        <ul className="list-disc ml-5 space-y-1">
                            <li>Folk Band “GM FOLK”</li>
                            <li>Paintball Club</li>
                        </ul>
                    </li>
                </ul>
            <li><strong className='font-semibold'>University Clinics & Hospitals:</strong>  Geomedi Rehabilitation Clinic and Simulation Medicine Clinic are some internal university clinics that are provided by the management to facilitate training activities. Simulation training is known to be one of the best ways to learn and acquire medical skills practically. Also, Geomedi University has affiliations and partnerships with hospitals and clinics in Tbilisi where students get to practice their skills in the final year of their study, along the patient’s bedside. Some such partner hospitals & clinics are:</li>
                <ul className='list-disc ml-5 space-y-1'>
                    <li>GSC Rustavi Central Hospital</li>
                    <li>Academician N. Kipshidze Central University Clinic, LTD</li>
                    <li>“K. Eristavi National Center for Experimental and Clinical Surgery”</li>
                    <li>Khechinashvili University Clinic, LTD</li>
                    <li>Iverieli Endocrinology, Metabology, Dietology Center “ENMEDIC”, LTD</li>
                    <li>Institute of Neurology and Neuropsychology, LTD</li>
                    <li>M-M-T Hospital, LTD</li>
                    <li>Infectious Diseases, Aids, And Clinical Immunology Research Center, LTD</li>
                    <li>Tsitlanadze Scientific-Practical Centre of Rheumatology, LTD</li>
                </ul>
            <li><strong className='font-semibold'>Laboratory:</strong> The medical course at Georgian National University SEU includes practical labs, computer labs, and simulation labs. The simulation labs have dummies and modern simulators for students to work with.</li>
            <li><strong className='font-semibold'>Hostel Facility:</strong> Geomedi University does not have a university hostel; however, Reddys Overseas can provide you with a list of apartments and shared accommodations where you can choose to stay, depending on your budget and suitability.</li>
        </ul>
        </section>
      ...
      {/* Fees Structure */}
        ...
        <div className="overflow-x-auto mb-5">
            ...
            <thead className="bg-gray-100">
                <tr>
                <th className="text-center border border-gray-300 bg-gray-500 p-2">Geomedi University</th>
            ...
            <tbody className='border border-gray-400 text-sm'>
                ...
                <td className="text-center border border-gray-400 p-2">$5,500 USD/ year</td>
                </tr>
                <tr>
                ...
                <td className="text-center border border-gray-400 bg-gray-200 p-2">NA</td>
                </tr>
                <tr>
                <td className="text-center border border-gray-400 p-2">Tuition Fees (INR)</td>
                <td className="text-center border border-gray-400 p-2">MBBS (MD) Program</td>
                <td className="text-center border border-gray-400 p-2">₹480,397/ year</td>
                </tr>
                <tr>
