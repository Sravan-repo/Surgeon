...
const address = '2/6 Ljubljana, Tbilisi 0159, Georgia; 79 Sanapiro Street, Rustavi, Georgia';

const DavidTvildiani = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-6 md:px-12 mt-8">
      ...
      <div className="w-full flex flex-col md:flex-row mb-12 gap-8 items-center">
        <img
          src={David}
          alt="David Tvildiani Medical University"
        ...
        Established as a medical school in 2011, David Tvildiani Medical University is a private medical institution in Tbilisi, Georgia. The university also operates in another location in Georgia, known as Rustavi. The Medical Doctor program at the university lasts 6 years. It consists of three stages: Basic Medical Science that spans 2.5 years, Clinical Science that spans 2.5 years, and Clinical Internship in the final year. Two MD undergraduate programs are offered by the Faculty of General Medicine at David Tvildiani Medical University's AIETI Medical School. The first MD program is primarily organized as a system-oriented program. The second MD e-PBL program, a newly accredited program, follows the framework of ERASMUS+ projects and focuses on virtual patients, as well as PBL. With a global curriculum and following the USMLE requirements, David Tvildiani Medical University’s medical degree is recognized globally. The university aims to create awareness in society, destroy supernatural beliefs, and increase healthcare facilities that can help people in need.
        </p>
      </header>
    </div>
      ...
      <section className="mb-5 text-sm ">
        <h2 className="font-semibold text-md text-black mb-2">
          Address of David Tvildiani Medical University
        </h2>
        ...
        <ul className="list-disc ml-5 text-sm space-y-1">
          <h3 className="font-medium text-md text-black mt-3 mb-2">The Faculty of Medicine at David Tvildiani Medical University offers the Medical Doctor program in English. Some goals and objectives of the Faculty of Medicine are as follows:</h3>
            <li>Impart professional and ethical values to medical students for them to become worthy doctors of the future.</li>
            ...
            <li>Contribute to the field of biomedicine, medicine, and healthcare sciences, significantly.</li>
        </ul>
        </section>
        ...
        <ul className="list-disc ml-5 text-sm space-y-1">
        <li><strong className='text-black font-semibold'>Medical Doctor: </strong>The MBBS or MD program at David Tvildiani Medical University spans 6 years and follows the global standard of education. With the curriculum designed as per international standards, the university provides theoretical, as well as practical training to the medical students to be able to excel in their field of expertise. On completion of the 6-year course, the student is awarded an MD degree and can practice as a professional anywhere they want.</li>
        </ul>
        </section>

        {/* Facilities */}
        <section ref={sectionRefs.facilities} id="facilities" className="mb-5 scroll-mt-24">
        <h2 className="font-semibold text-md text-black mb-3">Facilities at the David Tvildiani Medical University</h2>
        <ul className="list-disc ml-5 text-sm space-y-1">
            <li><strong className='font-semibold'>Library:</strong>David Tvildiani Medical University is known to provide the best standards for medical and research activities. The facilities included along with the MD course in English by the David Tvildiani Medical University are as follows:</li>
            ...
            <li><strong className='font-semibold'>University Clinics:</strong> David Tvildiani Medical University has collaborations with hospitals and clinics in Georgia and even abroad. Clinical internships and exchange programs are held to train students in the field of medical sciences. Some affiliated clinical bases in Georgia are:</li>
                <ul className="list-disc ml-5 space-y-1">
                    <li>LTD “Institute of Neurology and Neuropsychology”</li>
                    <li>LTD Center of Allergy and Immunology</li>
                    <li>JSC “National Center for Tuberculosis and Lung Disease (NCTBLD)”</li>
                    <li>LTD “Tbilisi Central Hospital”</li>
                    <li>LTD “National Center for Diabetes Research”</li>
                    <li>LTD “Rustavi Central Hospital “</li>
                    <li>Beritashvili Center of Experimental Biomedicine</li>
                    <li>JSC “Modern Medical Technologies Hospital”</li>
                    <li>JSC “AIDS Center”</li>
                    <li>LTD “Bochua Memorial Cardiovascular Center”</li>
                    <li>LTD “Children Rehabilitation Center “Rehab”</li>
                    <li>LTD “Tbilisi Cancer Center”</li>
                    <li>Some partner hospitals abroad are:</li>
                    <ul className="list-disc ml-5 space-y-1">
                        <li>Klaipeda hospital (Lithuania)</li>
                        <li>Vilnius University Hospital (Lithuania)</li>
                        <li>JCI-accredited hospital in Cochin, India</li>
                    </ul>
                </ul>
            ...
            <li><strong className='font-semibold'>Hostel Facility:</strong>The Rustavi campus of David Tvildiani Medical University has a dormitory facility with comfortable accommodation in rooms with 4, 3, and 2 beds. In case you are looking for accommodations near the Tbilisi campus, Reddys Overseas can help you with a list of shared and private accommodations. You can carefully check the facilities and choose a place to stay depending on your requirements and budget.</li>
        </ul>
        </section>
      ...
      {/* Fees Structure */}
        ...
        <div className="overflow-x-auto mb-5">
            ...
            <thead className="bg-gray-100">
                <tr>
                <th className="text-center border border-gray-300 bg-gray-500 p-2">David Tvildiani Medical University</th>
