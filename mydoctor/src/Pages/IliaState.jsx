...
const address = 'N, 32 Ilia Chavchavadze Avenue, Tbilisi, Georgia';
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-6 md:px-12 mt-8">
      ...
      <div className="w-full flex flex-col md:flex-row mb-12 gap-8 items-center">
        ...
        Ilia State University (ISU), a higher-education institution in Tbilisi, Georgia, was established in July 1930. The university emphasizes continuous staff training, quality education, and a global curriculum that focuses on creating a labor force that can respond to the job market. 
        Headed by an academic council, followed by a rector, and then the teacher, as well as other staff, Ilia State University has a structured management. 
        The Medical Doctor program at Ilia State University offered in the English language of instruction, was implemented in 2012. 
        Provisions such as Project-Based Learning and Virtual handling of patients are made available in the MD program at Ilia State University. Following the sector benchmarks of the World Federation of Medical Education, the university has global accreditations that make its degree recognized around the world.</p>
        </header>
      </div>
      ...
      <section className="mb-5 text-sm ">
        <h2 className="font-semibold text-md text-black mb-2">
          Address of Ilia State University
        </h2>
        ...
        <h2 className="font-semibold text-md text-black mb-3">Facilities at the Ilia State University</h2>
        <ul className="list-disc ml-5 text-sm space-y-1">
            <li><strong className='font-semibold'>Library:</strong>Ilia State University is known to provide the best standards for medical and research activities. The facilities included along with the MD course in English by the Ilia State University are as follows:</li>
            <ul className="list-disc ml-5 space-y-1">
                <li>The New England Journal of Medicine</li>
                <li>EBSCO Discovery Service</li>
                <li>Cambridge Journals</li>
                <li>Clarivate Analytics</li>
            ...
            <li><strong className='font-semibold'>Clubs & Associations: </strong>Georgian National University SEU allows students to participate, in and create different clubs, and unions, or even organize events, based on their area of interest. Some such clubs, and associations formed at the university are:</li>
                <ul className="list-disc ml-5 space-y-1">
                    ...
                    <li><strong className='font-semibold'>Clubs & Associations: </strong>To satisfy the intellectual, and overall developmental needs of the students, Georgian National University SEU, at present, has the following clubs for students to participate in:
                        <ul className="list-disc ml-5 space-y-1">
                            <li>ILIAUNI Chess Club</li>
                            <li>ILIAUNI Board Games Club</li>
                            <li>ILIAUNI Psychology Club</li>
                            <li>Business Club</li>
                            <li>Law and Liberty Student Club</li>
                            <li>International Relations Club</li>
                            <li>Publicity Student Club</li>
                            <li>Literary Club</li>
                            <li>Digital Science Club</li>
                            <li>Folk Songs Club</li>
                            <li>ILIAUNI Gender Equality Student Club</li>
                        </ul>
                    </li>
                </ul>
      ...
      {/* Fees Structure */}
        ...
        <div className="overflow-x-auto mb-5">
            ...
            <tbody className='border border-gray-400 text-sm'>
                ...
                <td className="text-center border border-gray-400 p-2">$6,200 USD/ year</td>
                </tr>
                <tr>
                ...
                <td className="text-center border border-gray-400 p-2">MBBS (MD) Program</td>
                <td className="text-center border border-gray-400 p-2">₹540,441.47/ year</td>
                </tr>
                <tr>
