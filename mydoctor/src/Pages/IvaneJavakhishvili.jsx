...
const address = '1 Ilia Chavchavadze Avenue, Tbilisi 0179, Georgia';
    ...
    <div className="max-w-6xl mx-auto py-10 px-6 md:px-12 mt-8">
      ...
      <section className="mb-5 text-sm ">
        <h2 className="font-semibold text-md text-black mb-2">
          Address of Ivane Javakhishvili Tbilisi State University
        </h2>
        ...
        <ul className="list-disc ml-5 text-sm space-y-1">
          <h3 className="font-medium text-md text-black mt-3 mb-2">The Faculty of Medicine at Ivane Javakhishvili Tbilisi State University offers the Medical Doctor program in English. Some goals and objectives of the Faculty of Medicine are as follows:</h3>
        ...
        <h2 className="font-semibold text-md text-black mb-3">Facilities at the Ivane Javakhishvili Tbilisi State University</h2>
        <ul className="list-disc ml-5 text-sm space-y-1">
            <li><strong className='font-semibold'>Library:</strong>Ivane Javakhishvili Tbilisi State University is known to provide the best standards for medical and research activities. The facilities included along with the MD course in English by the Ivane Javakhishvili Tbilisi State University are as follows:</li>
