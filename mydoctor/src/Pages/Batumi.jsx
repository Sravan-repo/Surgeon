...
import BatumiImg from '../assets/Batumi.jpg';
...
const address = '35/32 Ninoshvili/Rustaveli str, Batumi 6010, Georgia';
    ...
    <div className="max-w-6xl mx-auto py-10 px-6 md:px-12 mt-8">
      ...
      <div className="w-full flex flex-col md:flex-row mb-12 gap-8 items-center">
        ...
        <header className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="text-sm text-gray-800">
            Batumi Shota Rustaveli State University was established 85 years ago through a series of events that began in 1893, eventually resulting in the formation of the university in 1935. With seven faculties in place, Batumi Shota Rustaveli State University has three research institutes, and over 6,000 students enrolled in Bachelor, Master, and Doctoral programs. Presently, the institute is known to be a scientific and educational university with the medical doctor program offered in English. The MD program is regulated by the Faculty of Natural Sciences and Healthcare, which aims to provide the highest standards of professionalism to create quality future physicians. With the provision of PhD-level programs and lifelong learning, the university ensures that students get to pursue a specialization in their field of interest after completing MBBS from Batumi Shota Rustaveli State University.
        </p>
        </header>
      </div>
      ...
      <section className="mb-5 text-sm ">
        <h2 className="font-semibold text-md text-black mb-2">
          Address of Batumi Shota Rustaveli State University
        </h2>
        ...
        <h2 className="font-semibold text-md text-black mb-3">Facilities at the Akaki Tsereteli State University</h2>
        <ul className="list-disc ml-5 text-sm space-y-1">
            <li><strong className='font-semibold'>Library:</strong>Akaki Tsereteli State University is known to provide the best standards for medical and research activities. The facilities included along with the MD course in English by the Akaki Tsereteli State University are as follows:</li>
