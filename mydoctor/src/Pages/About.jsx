  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[-15px] hover:bg-amber-500 hover:text-black transition-all duration-300 text-black cursor-pointer'>
        <b>EFFICIENCY:</b>
